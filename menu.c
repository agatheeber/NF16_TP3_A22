...
int main() {
    ...
    while (continu==1){  //affichage menu
        ...
        printf("4. Donner la valeur d’un élément d’une matrice creuse\n");
        printf("5. Affecter une valeur à un élément d’une matrice creuse\n");
        printf("6. Additionner deux matrices creuses\n");
        printf("7. Calculer le gain en espace en utilisant cette représentation pour une matrice donnée\n");
        printf("8. Quitter\n");
        printf("saisir une option : 1 pour 1., 2 pour 2, ...");
        int x;
        scanf("%d",&x); //sélection du menu
        system("cls"); //effacage de l'écran par soucis de lisibilité
        switch(x){
        case 1:
            ...
            case 7 :
                    printf("saisir le numéro de la matrice dont on souhaite afficher lenombre d'octets gagnés (les matrices disponibles sont %s %s %s %s)", listemat[0], listemat[1],listemat[2], listemat[3]);
                    int e;
                    scanf("%d",&e);
                    switch(e){
